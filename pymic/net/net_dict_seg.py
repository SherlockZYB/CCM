...
from pymic.net.net2d.resnet_simclr import ResNet_SimCLR
...
from pymic.net.net2d.unet2d_res50 import UNet2D_res50
from pymic.net.net2d.unet2d_conmae import UNet2D_conmae
...
SegNetDict = {
    ...
    'UNet2D_res50': UNet2D_res50,
    'UNet2D_conmae': UNet2D_conmae,
	# 'TransUNet': TransUNet,
	# 'SwinUNet': SwinUNet,
	'UNet2D5': UNet2D5,
	'UNet3D': UNet3D,
