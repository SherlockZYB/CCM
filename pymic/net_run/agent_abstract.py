...
class NetRunAgent(object):
    ...
    @abstractmethod    
    def sget_stage_dataset_from_config(self, stage):
        """
    ...
    def create_dataset(self):
        ...
        if(self.stage == 'train'):
            ...
            self.train_loader = torch.utils.data.DataLoader(self.train_set, 
                ...
                worker_init_fn=worker_init, generator = g_train, pin_memory=True)
            self.valid_loader = torch.utils.data.DataLoader(self.valid_set, 
                batch_size = bn_valid, shuffle=False, num_workers= num_worker,
                worker_init_fn=worker_init, generator = g_valid, pin_memory=True)
        else:
